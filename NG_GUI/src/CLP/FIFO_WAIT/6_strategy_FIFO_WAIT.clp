...
=>
  ...
  (if (> ?level 0)
    then
      ...
      (assert (printGUI (time ?t1) (step ?current) (source "DEB") (verbosity 0) (text  "Inizializza Fase 1 - target tavolo: %p1") (param1 ?sen)))
...
=>
  ...
  (if (> ?level 0)
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Dispenser/Basket Found in: %p1, %p2") (param1 ?rd1) (param2 ?cd1)))
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Init Phase 3: Pianifica Astar verso dispenser")))
  )
)
...
=>
  ...
  (if (> ?level 0)
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Agent hasn't space available. Useless found dispenser.")))
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Init Phase 5, a-star towards table %p1, order") (param1 ?id)))
  )
)
...
=>
  ...
  (if (> ?level 0)
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Init Phase 4 - Agent in front of best dispenser: %p1 in %p2,%p3") (param1 ?c) (param2 ?rd) (param3 ?cd)))
  )
)
...
=>
  ...
  (if (> ?level 0)
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Init Phase 3: Plane Failed. Wait and try again go to: %p1 in %p2,%p3") (param1 ?c) (param2 ?rd) (param3 ?cd)))
...
=>
  ...
  (if (> ?level 0)
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "A-Star not found solution to the dispenser: %p1 in %p2,%p3") (param1 ?c) (param2 ?rd) (param3 ?cd)))
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Wait and try again.")))
  )
)
;
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Loading food in dipsenser FD")))
  )
)
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Loading drink in dispenser DD")))
  )
)
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "EmptyFood in TrashBasket: %p1 %p2") (param1 ?rfo) (param2 ?cfo))) 
  )
)
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Release drink in RecyclableBasket: %p1 %p2") (param1 ?rfo) (param2 ?cfo))) 
  )
)
...
=>
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Agent has space available, return to Phase 2"))) 
...
=>
  ...
  then
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Agent has trash, return to Phase 2: agent trash")))
    )
  else
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Agent has finished trashing, starting serving table")))
    )
  )
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Init Phase 5, a-star towards table %p1") (param1 ?id)))
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Init Phase 6, Agent in front of table %p1") (param1 ?id)))
  )
)
...
=>
  ...
  (if (> ?level 0)
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Init Phase 5: Plane Failed. Wait and try again")))
  )
)
...
=>
  ...
  (if (> ?level 0)
    ...
    (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "A-Star not found solution to the table. Wait and try again.")))
  )
)
;
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Delivery Food")))
  )
)
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Delivery Drink")))
  )
)
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "CleanTable")))
  )
)
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Order not completed, return to phase 2")))
  )
)
...
=>
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "CleanTable, sono pieno di trash, return to phase 2")))
  )
)
...
=> 
  ...
  (assert (printGUI (time ?time) (step ?current) (source "DEB") (verbosity 0) (text  "Order at step %p1 of table: %p2 is completed") (param1 ?step) (param2 ?id)))
  )
)