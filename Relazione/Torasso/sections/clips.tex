...
\subsection{Risultati sulla mappa 10x10: history_default}
\begin{table}[h]
...
Order performed        & 10         & 10        & 10           & 10   \\ \hline
Total orders           & 7          & 7         & 6            & 6    \\ \hline
\end{tabular}
\end{table}

Dalla tabella notiamo che la strategy HARD è quella che minimizza la nostra penalità. Questo risultato può essere forviante in quanto dipende dal numero di ordini che la strategia riesce a servire. Questo numeropuò variare a second della strategia in quanto ordini inseriti nella history non sono consistenti con l'esecuzione di una strategia e non vengono presi in carico dal sistema. Per questo motivo un metro di giudizio non è stato il valore della penalty, ma la penalty media per ogni ordine.
...
\subsection{Risultati sulla mappa 10x10: history_simple}
\begin{table}[h]
\begin{tabular}{|c|c|c|c|l|}
\hline
\multicolumn{1}{|l|}{} & FIFO\_BASE & FIFO\_PRO & LOW\_PENALTY & HARD \\ \hline
