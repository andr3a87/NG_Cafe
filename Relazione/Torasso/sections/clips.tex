...
\hline
                 & FIFO\_BASE & FIFO\_PRO & LOW\_PENALITY & PENDIST & HARD \\ \hline
...
Dalla tabella notiamo che la strategy HARD è quella che minimizza la nostra penalità. Questo risultato può essere fuorviante in quanto dipende dal numero di ordini che la strategia riesce a servire. Questo numero può variare a second della strategia in esecuzione in quanto ordini inseriti nella history non sono consistenti con tale esecuzione e non vengono presi in carico dal sistema. Per questo motivo un metro di giudizio non è stato il valore della penalty, ma la penalty media per ogni ordine.
