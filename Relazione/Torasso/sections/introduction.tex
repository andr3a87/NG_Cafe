...
\begin{itemize}
  ...
  \item Fase 6: Il robot in questa fase si trova in una posizione su cui può operare sul tavolo. Nel caso di ordine accepted rilascio tuttle le consumazioni caricate; in caso di ordine finish o delayed pulisco il tavolo.
